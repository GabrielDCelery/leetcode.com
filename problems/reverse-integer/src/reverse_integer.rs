...
impl Solution {
    pub fn reverse(x: i32) -> i32 {
        ...
        let mut vec_of_digits = Solution::transform_int_to_vec_of_digits(x.abs());
        Solution::reverse_vec_of_digits(&mut vec_of_digits);
        let number = Solution::transform_vec_of_digits_to_int(&vec_of_digits);
        return sign * number;
    }
